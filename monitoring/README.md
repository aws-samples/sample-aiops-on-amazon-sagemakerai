...
| **Infrastructure** | SageMaker Pipeline | CDK Lambda + EventBridge | SageMaker Pipeline + EventBridge Scheduler + SNS | SageMaker + Lambda + Athena | CDK Serverless | Managed Grafana | Managed Grafana + CloudWatch |
