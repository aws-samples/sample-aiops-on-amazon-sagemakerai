...
class GroundTruthSimulator:
    ...
    def __init__(
        ...
        Args:
            ...
            accuracy: How often predictions match ground truth (0.0-1.0)
        ...
        logger.info(f"Initialized GroundTruthSimulator with accuracy={accuracy}")
    ...
    def simulate_ground_truth(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"Simulating ground truth with {self.accuracy*100:.1f}% accuracy...")
        ...
        # Introduce errors to reach target accuracy
